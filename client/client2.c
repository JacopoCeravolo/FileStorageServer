...
int main(int argc, char const *argv[])
{
   ...
   log_init(NULL);
    ...
    sleep(1); open_file(socket_fd, "Makefile");


    
    sleep(1); write_file(socket_fd, "file500");

    
    sleep(1); write_file(socket_fd, "file500_copy");

    
    sleep(1); write_file(socket_fd, "longfile");

    
    sleep(1); write_file(socket_fd, "full");

    
    sleep(1); write_file(socket_fd, "Makefile"); */
